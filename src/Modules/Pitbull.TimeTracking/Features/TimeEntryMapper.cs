...
public static class TimeEntryMapper
{
    public static TimeEntryDto ToDto(TimeEntry timeEntry)
    {
        return new TimeEntryDto(
            ...
            PhaseName: timeEntry.Phase?.Name,
            EquipmentId: timeEntry.EquipmentId,
            EquipmentName: timeEntry.Equipment?.Name,
            EquipmentCode: timeEntry.Equipment?.Code,
            EquipmentHours: timeEntry.EquipmentHours,
