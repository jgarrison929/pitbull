...
public class TimeEntryAuditController(PitbullDbContext auditDb, ITenantContext tenantContext) : ControllerBase
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        // AuditLog.Timestamp maps to a PostgreSQL 'timestamp with time zone' column, and
        // Npgsql rejects DateTime values with Kind=Unspecified (which is how DateTime query
        // params bind). Treat the supplied calendar date as a UTC day boundary.
        if (from.HasValue)
        {
