...
namespace Pitbull.Api.Migrations
{
    ...
    [Migration("20260730225500_AddFinancialAndOpsTablesTenantRls")]
    partial class AddFinancialAndOpsTablesTenantRls
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pitbull.AI.Domain.AiUsageRecord", b =>
                {
                    ...
                    b.HasIndex("TenantId", "CompanyId", "RequestedAt");
            ...
            modelBuilder.Entity("Pitbull.Billing.Domain.CurrencyExchangeRate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Pitbull.Billing.Domain.TaxExemption", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ExemptCategory")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)");
                    ...
                    b.HasIndex("TenantId", "CompanyId", "Scope", "EntityId")
                        .HasDatabaseName("IX_tax_exemptions_tenant_company_scope_entity");

                    b.ToTable("tax_exemptions", (string)null);
                });

            modelBuilder.Entity("Pitbull.Billing.Domain.TaxJurisdiction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Pitbull.Billing.Domain.TaxRate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "CompanyId", "TaxJurisdictionId", "Category")
            ...
            modelBuilder.Entity("Pitbull.Contracts.Domain.OwnerChangeOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("OwnerContractId");

                    b.HasIndex("Status");

                    b.HasIndex("TenantId");

                    b.HasIndex("ProjectId", "ChangeOrderNumber")
                        .IsUnique();

                    b.ToTable("owner_change_orders", (string)null);
                });
            ...
            modelBuilder.Entity("Pitbull.Contracts.Domain.Subcontract", b =>
                {
                    ...
                    b.HasIndex("TenantId", "CompanyId", "SubcontractNumber")
                        .IsUnique();
            ...
            modelBuilder.Entity("Pitbull.Core.Domain.VendorInvoice", b =>
                {
                    ...
                    b.Property<Guid?>("AccrualJournalEntryId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Pitbull.Core.Domain.VendorPayment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Pitbull.Core.Domain.VendorPaymentApplication", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "CompanyId", "VendorPaymentId")
            ...
            modelBuilder.Entity("Pitbull.Core.Domain.WipReportLine", b =>
                {
                    ...
                    b.Property<decimal?>("EvPercentComplete")
                        .HasPrecision(8, 6)
                    ...
                    b.Property<decimal?>("ProjectedGainLoss")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
            ...
            modelBuilder.Entity("Pitbull.Core.Domain.WorkflowApprovalAction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("WorkflowApprovalStepId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("AssignedToUserId", "Status", "CreatedAtUtc")
                    ...
                    b.ToTable("workflow_approval_actions", (string)null);
                });

            modelBuilder.Entity("Pitbull.Core.Domain.WorkflowApprovalStep", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<string>("ApproverRelationship")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
            ...
            modelBuilder.Entity("Pitbull.Core.Domain.WorkflowDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("RejectedStatus")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
            ...
            modelBuilder.Entity("Pitbull.ProjectManagement.Domain.ModelAsset", b =>
                {
                    ...
                    b.Property<Guid?>("PublishedGraphId")
                        .HasColumnType("uuid");

                    b.Property<string>("RuntimeBlobKey")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");

                    b.Property<string>("SourceBlobKey")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
                    ...
                    b.HasIndex("ProjectId", "IsActiveVersion");

                    b.HasIndex("ProjectId", "VersionNumber");

                    b.ToTable("pm_model_assets", (string)null);
                });
            ...
            modelBuilder.Entity("Pitbull.ProjectManagement.Domain.PmScheduleActivity", b =>
                {
                    ...
                    b.Property<Guid?>("PrimarySpatialNodeId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PrimarySpatialNodeId");
            ...
            modelBuilder.Entity("Pitbull.ProjectManagement.Domain.SpatialGraph", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("pm_spatial_graphs", (string)null);
                });

            modelBuilder.Entity("Pitbull.ProjectManagement.Domain.SpatialNode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<decimal?>("CentroidX")
                        .HasPrecision(12, 3)
                        .HasColumnType("numeric(12,3)");

                    b.Property<decimal?>("CentroidY")
                        .HasPrecision(12, 3)
                        .HasColumnType("numeric(12,3)");

                    b.Property<decimal?>("CentroidZ")
                        .HasPrecision(12, 3)
                        .HasColumnType("numeric(12,3)");
                    ...
                    b.HasIndex("GraphId", "Code")
                        .IsUnique();

                    b.HasIndex("ProjectId", "NodeType", "IsActive");

                    b.ToTable("pm_spatial_nodes", (string)null);
                });

            modelBuilder.Entity("Pitbull.ProjectManagement.Domain.SpatialPlanLink", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PlanSheetId");

                    b.HasIndex("TenantId");

                    b.HasIndex("ProjectId", "PlanSheetId");

                    b.HasIndex("SpatialNodeId", "PlanSheetId")
                        .IsUnique();

                    b.ToTable("pm_spatial_plan_links", (string)null);
                });
            ...
            modelBuilder.Entity("Pitbull.SystemAdmin.Domain.SecretVault", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("secret_vault", (string)null);
                });
            ...
            modelBuilder.Entity("Pitbull.SystemAdmin.Domain.TenantSettings", b =>
                {
                    ...
                    b.Property<int>("SeedDataVersion")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Pitbull.Billing.Domain.TaxRate", b =>
                {
                    b.HasOne("Pitbull.Billing.Domain.TaxJurisdiction", "TaxJurisdiction")
                        .WithMany("Rates")
                    ...
                    b.OwnsOne("Pitbull.Core.Domain.PaymentApplicationSettings", "PaymentApplicationSettings", b1 =>
                        {
                            ...
                            b1.Property<int>("DefaultPaymentTermDays")
                                .HasColumnType("integer");
                    ...
                    b.OwnsOne("Pitbull.Core.Domain.ProjectSettings", "ProjectSettings", b1 =>
                        {
                            ...
                            b1.Property<bool>("RequireSpatialOnProgress")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("boolean")
                                .HasDefaultValue(false)
            ...
            modelBuilder.Entity("Pitbull.Core.Domain.VendorPaymentApplication", b =>
                {
                    ...
                    b.HasOne("Pitbull.Core.Domain.VendorPayment", "VendorPayment")
            ...
            modelBuilder.Entity("Pitbull.Core.Domain.WorkflowApprovalAction", b =>
                {
                    b.HasOne("Pitbull.Core.Domain.WorkflowApprovalStep", "ApprovalStep")
                        .WithMany()
            ...
            modelBuilder.Entity("Pitbull.Core.Domain.WorkflowApprovalStep", b =>
                {
                    b.HasOne("Pitbull.Core.Domain.WorkflowDefinition", "WorkflowDefinition")
                        .WithMany("Steps")
            ...
            modelBuilder.Entity("Pitbull.ProjectManagement.Domain.SpatialNode", b =>
                {
                    b.HasOne("Pitbull.ProjectManagement.Domain.SpatialGraph", null)
                        .WithMany()
                        .HasForeignKey("GraphId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Pitbull.ProjectManagement.Domain.SpatialNode", null)
                        .WithMany()
