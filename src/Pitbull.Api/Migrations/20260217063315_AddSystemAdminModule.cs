...
{
    /// <inheritdoc />
    public partial class AddSystemAdminModule : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KeyFingerprint = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnableTimeTracking = table.Column<bool>(type: "boolean", nullable: false),
                    EnableBidManagement = table.Column<bool>(type: "boolean", nullable: false),
                    EnableDocumentManagement = table.Column<bool>(type: "boolean", nullable: false),
                    EnableSubcontractorPortal = table.Column<bool>(type: "boolean", nullable: false),
                    xmin = table.Column<uint>(type: "xid", rowVersion: true, nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ai_api_keys_TenantId",
                table: "ai_api_keys",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_ai_api_keys_TenantId_IsActive",
                table: "ai_api_keys",
                columns: new[] { "TenantId", "IsActive" });

            migrationBuilder.CreateIndex(
                name: "IX_ai_api_keys_TenantId_Provider",
                table: "ai_api_keys",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_api_keys_TenantId_Status",
                table: "api_keys",
