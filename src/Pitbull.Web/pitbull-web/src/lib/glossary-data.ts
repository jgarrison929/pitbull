...
export const glossaryTerms: GlossaryTerm[] = [
  ...
  { id: "digital-twin", term: "Digital Twin", definition: "Zones-first spatial view of a job (site → building → storey → zones) with overlay colors from linked RFIs, progress, and schedule. Bands marked insufficient or with * are proxies — not invent green health.", category: "project-management", aliases: ["Jobsite Twin", "Spatial Status"], relatedTerms: ["daily-report", "rfi"] },
  { id: "daily-report", term: "Daily Report", definition: "A log of daily construction activities including weather, workforce counts, equipment used, work performed, visitors, and any delays or issues. Optional SpatialNodeId attaches the report to a twin zone.", category: "project-management", aliases: ["Daily Log"], relatedTerms: ["digital-twin"] },
