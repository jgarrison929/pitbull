...
import { projectTypeOptions } from "@/lib/projectEnums";
import { toast } from "sonner";

type FormErrors = Partial<Record<"number" | "name" | "contractAmount" | "dates", string>>;

export default function NewProjectPage() {
  const router = useRouter();
  const [isSubmitting, setIsSubmitting] = useState(false);

  // The API expects a numeric enum for ProjectType.
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-2">
                ...
                <Input id="number" name="number" placeholder="P-2026-001" required />
