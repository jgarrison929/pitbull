  ...
  const commands = useMemo<CommandItem[]>(() => {
    ...
    items.push(
      ...
      },
      {
        id: "nav-payroll-runs",
        title: "Payroll Runs",
        subtitle: "View payroll processing runs",
        icon: <Landmark className="h-4 w-4" />,
        category: "navigation",
        action: () => { router.push("/payroll/runs"); close(); },
        keywords: ["payroll", "runs", "gross", "net"],
      },
      {
        id: "nav-certified-payroll",
        title: "Certified Payroll",
        subtitle: "View WH-347 certified payroll reports",
        icon: <Landmark className="h-4 w-4" />,
        category: "navigation",
        action: () => { router.push("/payroll/certified"); close(); },
        keywords: ["certified", "wh-347", "compliance", "payroll"],
      },
      {
        id: "nav-wage-determinations",
        title: "Wage Determinations",
        subtitle: "Manage prevailing wage rate tables",
        icon: <Landmark className="h-4 w-4" />,
        category: "navigation",
      ...
      },
      {
        ...
        subtitle: "View pending PM payroll reviews",
        icon: <Landmark className="h-4 w-4" />,
        category: "navigation",
        action: () => { router.push("/payroll/reviews"); close(); },
        keywords: ["review", "approval", "pm", "workflow"],
      },
      {
        id: "nav-payroll-exports",
        title: "Payroll Exports",
        subtitle: "Generate ADP/Paychex/CSV payroll files",
        icon: <Landmark className="h-4 w-4" />,
        category: "navigation",
        action: () => { router.push("/payroll/exports"); close(); },
        keywords: ["export", "adp", "paychex", "quickbooks", "csv"],
      },
      {
        id: "nav-owner-contracts",
        title: "Owner Contracts",
        subtitle: "View owner contracts for AIA billing",
        icon: <FileText className="h-4 w-4" />,
        category: "navigation",
        action: () => { router.push("/billing/contracts"); close(); },
        keywords: ["billing", "aia", "g702", "owner", "contract"],
      },
      {
        id: "nav-billing-applications",
        title: "Billing Applications",
        subtitle: "View AIA G702 billing applications",
        icon: <Landmark className="h-4 w-4" />,
        category: "navigation",
        action: () => { router.push("/billing/applications"); close(); },
