...
Pitbull is an agentic back-office platform for construction companies. It replaces Vista/Viewpoint, Procore, and SharePoint with a modern, AI-native system of record.
...
- **Tests:** 1,820+ (unit + integration via Testcontainers)
...
src/
  ...
  Infrastructure/
    ...
    Pitbull.Messaging/                  # MassTransit event bus
...
// 2. MediatR/validation module registration
