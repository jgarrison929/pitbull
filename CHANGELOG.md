...
- **Today on site UI card** - project glance of real today counts with honest empty state.


## [3.3.2] - 2026-07-15T11:08:08-07:00

### Added

- **Today on site client helpers** - empty copy + summary formatter (no health KPIs).


## [3.3.1] - 2026-07-15T10:48:09-07:00

### Added

- **Today on site API** - GET /api/projects/{id}/today-on-site with real daily report/photo/open RFI counts for UTC day.
...
- **API client transient retries** - GET requests retry with backoff on network errors and 502/503/504; never retries POST/mutations (no invented success).
