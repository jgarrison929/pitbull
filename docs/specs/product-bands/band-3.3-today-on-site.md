...
**CI notes:** `docs/ci/mobile-3.3-today-on-site-notes.md`
...
| **3.3.1** | API: `GET /api/projects/{id}/today-on-site` slim DTO — counts from real daily reports / RFIs for **today** (UTC day boundary documented) |
...
| **3.3.8** | Buffer: residual honesty guards only (no new scope) |
