...
> **Note:** HR and Payroll modules were removed Feb 9 as incomplete - scheduled for v2. Test count rebuilt to 1017 with expanded coverage including soft-delete and ID mismatch edge cases.
