...
public sealed class ProjectsEndpointsTests(PostgresFixture db) : IAsyncLifetime
{
    ...
    // Note: V2 test endpoints were removed as part of MediatR migration (commit 3d6ed9f)
    // The main endpoints now use direct service calls and the V2 endpoints are no longer needed.
