...
public class ListProjectsValidatorTests
{
    private readonly ListProjectsValidator _validator = new();
    ...
    public void PaginationQuery_AutoClampsInvalidValues_NoValidationNeeded()
    {
        ...
        var queryNegativePage = new ListProjectsQuery() { Page = -1 };
        var queryZeroPage = new ListProjectsQuery() { Page = 0 };
        var queryLargePageSize = new ListProjectsQuery() { PageSize = 1000 };
        var queryZeroPageSize = new ListProjectsQuery() { PageSize = 0 };
    ...
    public void Search_WithLongString_ShouldFail()
    {
        ...
        var query = new ListProjectsQuery(Search: longSearch);
    ...
    {
        // Arrange
        var query = new ListProjectsQuery(Search: validSearch);
    ...
    public void Search_WithExactly200Characters_ShouldPass()
    {
        ...
        var query = new ListProjectsQuery(Search: exactSearch);
    ...
    public void ValidQuery_ShouldPassAllValidation()
    {
        ...
        var query = new ListProjectsQuery(
            Status: Projects.Domain.ProjectStatus.Active,
